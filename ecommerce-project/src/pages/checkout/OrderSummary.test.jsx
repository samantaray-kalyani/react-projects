...
describe('OrderSummary component', () => {
  ...
  beforeEach(() => {
    ...
    deliveryOptions = [{
      ...
      deliveryDays: 7,
      priceCents: 0,
      estimatedDeliveryTimeMs: 1747506600000,
    }, {
      id: '2',
      deliveryDays: 3,
      priceCents: 499,
      estimatedDeliveryTimeMs: 1747161000000,
    }, {
      id: '3',
      deliveryDays: 1,
      priceCents: 999,
      estimatedDeliveryTimeMs: 1746988200000,
    }];
  ...
  it('renders cart items correctly', () => {
    ...
    expect(
      ...
      let deliveryOptionInputs = 
      within(cartItemContainers[0]).getAllByTestId('delivery-option-input');
  ...
  it('does not render anything if cart is empty', () => {
    ...
    // We can't use getAllByTestId because if it doesn't find anyting, it will cause an error. Instead we use queryAllByTestId. This does the same thing as getAllByTestId it doesn't cause an error. If it doesn't find anything, it just returns an empty arry.
