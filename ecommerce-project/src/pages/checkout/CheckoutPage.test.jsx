...
describe('CheckoutPage component', () => {
  ...
  it('displays the page correctly', async () => {
    ...
    //Check the order summary is overall correct (since OrderSummary is tested in more detail in OrderSummary.test.jsx)
  expect(screen.getByText('Review your order')).toBeInTheDocument();
    ...
    //Check the payment summary is overall correct(since PaymentSummary is tested in more detail in PaymentSummary is tested in more detail in PaymentSummary.test.jsx)
